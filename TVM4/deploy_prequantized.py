...
#定义pytorch模型 静态量化，参考https://blog.csdn.net/oyjwin/article/details/117804263
# attach a global qconfig, which contains information about what kind
# of observers to attach. Use 'fbgemm' for server inference and 'qnnpack' for mobile inference.Other quantization configurations such
